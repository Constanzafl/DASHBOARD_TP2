...
if st.checkbox('**¿Que son las criptomonedas?**'):
...
if st.checkbox('**¿Cuantas criptomonedas hay?**'):
...
if st.checkbox('**¿Como funciona el sistema de transacciones o intercambio de criptomonedas?**'):
...
if st.checkbox('**¿Que es un sistema blockchain?**'):
...
if st.checkbox('**¿Donde se guardan las criptomonedas?¿Como puedo adquirirlas?**'):
...
if st.checkbox('**¿Que quiere decir que sea un sistema descentralizado?**'):
